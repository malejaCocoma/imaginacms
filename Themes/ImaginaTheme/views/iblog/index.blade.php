...
@section('content')
    <section id="category"
        ...
        <div id="content_index_blog"
             class="  {{isset($category->id) ? 'iblog-index-category iblog-index-category-'.$category->id.' blog-category-'.$category->id : ''}} py-1">
            <div class="border-breadcrumb">
                <div class="container">
            ...
            <div class="container mt-5">
                <div class="row">
                    ...
                    <div class="posts col-12 col-lg-9">
                        ...
                        <livewire:isite::items-list
                                ...
                                :itemComponentAttributes="[
                                    ...
                                    'buttonIconLR'=>'left',
                                    'buttonColor'=>'primary',
                                    'viewMoreButtonLabel'=>'icustom::common.label-btn-articles',
